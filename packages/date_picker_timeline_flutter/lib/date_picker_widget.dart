...
class DatePicker extends StatefulWidget {
  ...
  /// Indicator count for the date widget, this will be passed to the date widget and can be used to show indicators for events or appointments on that date
  final num? indicatorCount;
            ...
            switch (widget.calendarType) {
              case CalendarType.gregorianDate:
                return GregorianDateWidget(
                  date: date,
                  monthTextStyle: deactivatedMonthStyle,
                  dateTextStyle: isDeactivated
                      ? deactivatedDateStyle
                      : isSelected
                          ? selectedDateStyle
                          : widget.dateTextStyle,
                  dayTextStyle: deactivatedDayStyle,
                  width: widget.width,
                  locale: widget.locale,
                  selectionColor:
                      isSelected ? widget.selectionColor : Colors.transparent,
                  indicatorCount: widget.indicatorCount,
